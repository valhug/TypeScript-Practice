...
function ArticleCard({ article, onDelete, onEdit }: ArticleCardProps) {
    return (
        <div className='flex p-4 bg-white w-[40rem] mb-6 ml-[2rem] shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out'>
            <img 
                src={article.image} 
                alt={article.title}
