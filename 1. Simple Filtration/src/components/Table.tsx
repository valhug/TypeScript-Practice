...
function ProjectTable () {
    ...
    const [filteresVisible, setFilteresVisible] = useState(false);
    ...
    const handleSortedOptionClick = (key: string ) => {
        sortProjects(key);
   ...
   const handleStatusChange = ( index: number, newStatus: string ) => {
    ...
    i === index ? { ...project, status: newStatus, progress: newStatus === "Completed" ? "100%" : project.progress,} : project);
    setProjects(updatedProjects);
    setStatusDropdownVisible(null);
   };

   const filteredProjects = projects.filter((project) => (searchQuery === "" || Object.values(project).some((value) =>
        ...
        <div className="p-4 w-[93%] ml-[5rem]">
            ...
            <div className="flex items-center mb-5">
                <div className="relative">
                    <button
                        ...
                        className="border border-gray-700 flex items-center justify-center text-white p-2 reounded">
                        ...
                        {dropdownVisible && ( 
                            <div className="absolute top-full left-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg">
                                <button
                                    onClick={() => handleSortedOptionClick("client")}
                                    className="block px-4 py-2 text-white w-full hover:bg-gray-700">
                                        Name
                                </button>
                                <button
                                    onClick={() => handleSortedOptionClick("country")}
                                    className="block px-4 py-2 text-white hover:bg-gray-700">
                                        Country
                                </button>
                                <button
                                    onClick={() => handleSortedOptionClick("date")}
                                    className="block px-4 py-2 text-white w-full hover:bg-gray-700">
                                        Date
                                </button>
                            </div>
                ...
                <div className="relative ml-4 w-full">
                    <button
                        onClick={() => setFilteresVisible(!filteresVisible)}
                    ...
                    {/* Main Table */}
            <table className="min-w-full table-auto rounded border-gray-70 text-white">
                <thead>
                    <tr>
            ...
            <div className="flex justify-end mt-4">
                <button
                    ...
                    className="px-4 py-2 bg-gray-700 text-white rounded mr-2 disabled:opacity-58"
                    >
                        Previous
                </button>
