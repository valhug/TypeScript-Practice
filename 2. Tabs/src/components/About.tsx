        ...
        <section className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <p className="text-lg text-gray-700">
                    Antel is a talented software engineer with a passion for creating
                    ...
                    unparalleled. Antel's diverse skill set has enabled him to build
                ...
                <p className="mt-4 text-lg text-gray-700">
                    ...
                    apart. Antel's dedication to honing his skills in this area led him
                    down a path of self-discovery, taking advantage of every resource
                    available to him - Antel is also a lover of languages as he speaks
                    English, Spanish, and French, Tagalog, Pidgin and his local dialet Tiv fluently. His passion for learning and
                </p>
            </div>
        </section>
    );
